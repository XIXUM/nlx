...
public abstract class Predicate implements IPredicate {
  ...
  public INode doLinkTo(final String asType) {
    INode _xblockexpression = null;
    {
      ...
      if (Objects.equals(asType, PredicateConstants.BASE_FORM_)) {
        _matched=true;
      }
      if (!_matched) {
        if (Objects.equals(asType, PredicateConstants.CONJUGATION_)) {
          _matched=true;
        }
      }
      if (_matched) {
      ...
      if (!_matched) {
        if (Objects.equals(asType, PredicateConstants.TENSE_)) {
          _matched=true;
      ...
      if (!_matched) {
        if (Objects.equals(asType, PredicateConstants.SUB_CLASS_OF_)) {
          _matched=true;
      ...
      if (!_matched) {
        if (Objects.equals(asType, PredicateConstants.PRECEED_BY_)) {
          _matched=true;
