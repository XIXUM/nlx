<<<<<<< HEAD:source/de.validas.spedit.iedit.parent/de.validas.nlx.view.fxviews/src/de/validas/nlx/view/fxviews/views/SemanticViewSelector.java
/**
 * 
 */
...
import org.xixum.nlx.view.fxviews.access.ContextData;
...
public class SemanticViewSelector implements ISemanticViewSelector, IAdaptable, ISelectionListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection sel) {
		if (sel instanceof IStructuredSelection) {
			...
			if (viewer == null)
				viewer = PlatformUI.getWorkbench().getActiveWorkbenchWindow().getActivePage().findView("org.xixum.nlx.view.fxviews.views.SemanticFxViewPart");
...
>>>>>>> 28be792edcf63b5c495498de39713fad9b7858d6:source/org.xixum.nlx.parent/org.xixum.nlx.view.fxviews/src/org/xixum/nlx/view/fxviews/views/SemanticViewSelector.java
