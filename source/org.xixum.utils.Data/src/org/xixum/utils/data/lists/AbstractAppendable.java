...
public abstract class AbstractAppendable implements IAppendable {
	...
	/* (non-Javadoc)
	 * @see org.xixum.utils.data.lists.IAppendable#getSuccessor()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.xixum.utils.data.lists.IAppendable#setSuccessor(org.xixum.utils.data.lists.IAppendable)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.xixum.utils.data.lists.IAppendable#getPrecessor()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.xixum.utils.data.lists.IAppendable#setPrecessor(org.xixum.utils.data.lists.IAppendable)
	 */
	@Override
