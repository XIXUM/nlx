...
/**
 * This is the item provider adapter for a {@link de.validas.spedit.naturalLang.IgnoredText} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IgnoredTextItemProvider extends BlockElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public IgnoredTextItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNlPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Nl feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNlPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NaturalLangPackage.Literals.ELEMENTS__NL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NaturalLangPackage.Literals.IGNORED_TEXT__IGNORED,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/IgnoredText"));
	}
	...
	public String getText(Object object) {
		String label = ((IgnoredText)object).getNl();
		return label == null || label.length() == 0 ?
			getString("_UI_IgnoredText_type") :
			getString("_UI_IgnoredText_type") + " " + label;
	}
