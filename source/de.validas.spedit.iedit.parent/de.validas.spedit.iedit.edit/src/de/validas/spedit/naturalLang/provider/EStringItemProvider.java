...
/**
 * This is the item provider adapter for a {@link de.validas.spedit.naturalLang.EString} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EStringItemProvider extends ShortcutGenItemProvider {
	/**
	 ...
	 * @generated
	 */
	public EStringItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NaturalLangPackage.Literals.ESTRING__WORD,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NaturalLangPackage.Literals.ESTRING__SHORTCUT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EString"));
	}
	...
	public String getText(Object object) {
		String label = ((EString)object).getShortcut();
		return label == null || label.length() == 0 ?
			getString("_UI_EString_type") :
			getString("_UI_EString_type") + " " + label;
	}
