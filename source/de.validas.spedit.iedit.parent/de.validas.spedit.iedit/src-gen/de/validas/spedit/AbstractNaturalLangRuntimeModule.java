...
import de.validas.spedit.generator.NaturalLangGenerator;
import de.validas.spedit.parser.antlr.NaturalLangAntlrTokenFileProvider;
import de.validas.spedit.parser.antlr.NaturalLangParser;
import de.validas.spedit.parser.antlr.internal.InternalNaturalLangLexer;
import de.validas.spedit.scoping.NaturalLangScopeProvider;
import de.validas.spedit.serializer.NaturalLangSemanticSequencer;
import de.validas.spedit.serializer.NaturalLangSyntacticSequencer;
import de.validas.spedit.services.NaturalLangGrammarAccess;
import de.validas.spedit.validation.NaturalLangConfigurableIssueCodesProvider;
import de.validas.spedit.validation.NaturalLangValidator;
...
public abstract class AbstractNaturalLangRuntimeModule extends DefaultRuntimeModule {
	...
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("de.validas.spedit.NaturalLang");
	}
	
	public void configureFileExtensions(Binder binder) {
		if (properties == null || properties.getProperty(Constants.FILE_EXTENSIONS) == null)
			binder.bind(String.class).annotatedWith(Names.named(Constants.FILE_EXTENSIONS)).toInstance("nlx");
	}
